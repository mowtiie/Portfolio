...
🔗 **Live:** [mowtiie.cc](https://mowtiie.cc)
...
| File | Purpose |
|------|---------|
| `index.html` | Home page — hero, about, things, contact, verify |
| `work.html` | Work + awards page (linked from nav) |
| `style.css` | All styling, theme tokens, responsive rules |
| `script.js` | Theme toggle, project/award rendering, scroll animations |
| `voxel.js` | The 3D voxel scene |
| `projects.js` | Project list — edit this to add work |
| `awards.js` | Awards / certificates list |
| `key.asc` | Your PGP public key (replace placeholder) |
| `vercel.json` | Vercel config — enables clean URLs |
...
**Your details.** In `index.html`, search-and-replace with yours. Edit the two paragraphs inside `<section class="about">`.
...
- Scaffolded with [Claude](https://claude.ai)
